...
exports.onLogCreatedStreamToBigQuery = void 0;
...
function getBigQueryClient() {
    if (!bigquery) {
        ...
        bigquery = new bigquery_1.BigQuery(options);
    }
    return bigquery;
}
/**
 ...
 */
exports.onLogCreatedStreamToBigQuery = (0, firestore_1.onDocumentCreated)({
